...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner.setOnItemSelectedListener(new OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                //Toast.makeText(getApplicationContext(),"Bitcoin: " + adapterView.getItemAtPosition(i),Toast.LENGTH_SHORT).show();
    ...
    private void letsDoSomeNetworking(String url) {
        ...
        client.get(url, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                //Toast.makeText(getApplicationContext(),"Bitcoin: " + response.toString() ,Toast.LENGTH_SHORT).show();
    ...
    private void updateUI(BitcoinDataModel bitcoinDataModel) {
        mPriceTextView.setText(bitcoinDataModel.getDataConvert());
